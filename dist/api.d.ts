...
export declare function wrapMetadataFunction(
 ...
 */
export declare type AutocompleteParameterTypes =
 ...
 */
export declare type ParamDefFromOptionsUnion<T extends ParameterType, O extends ParameterOptions<T>> = Omit<
  O,
  'type' | 'autocomplete'
> & {
 ...
 * ```
 */
export declare function makeParameter<T extends ParameterType, O extends ParameterOptions<T>>(
  paramDefinition: O,
): ParamDefFromOptionsUnion<T, O>;
/** @deprecated */
export declare function makeStringParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.string>,
): ParamDef<Type.string>;
/** @deprecated */
export declare function makeStringArrayParameter(
  name: string,
  description: string,
  args?: ParamArgs<ArrayType<Type.string>>,
): ParamDef<ArrayType<Type.string>>;
/** @deprecated */
export declare function makeNumericParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.number>,
): ParamDef<Type.number>;
/** @deprecated */
export declare function makeNumericArrayParameter(
  name: string,
  description: string,
  args?: ParamArgs<ArrayType<Type.number>>,
): ParamDef<ArrayType<Type.number>>;
/** @deprecated */
export declare function makeBooleanParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.boolean>,
): ParamDef<Type.boolean>;
/** @deprecated */
export declare function makeBooleanArrayParameter(
  name: string,
  description: string,
  args?: ParamArgs<ArrayType<Type.boolean>>,
): ParamDef<ArrayType<Type.boolean>>;
/** @deprecated */
export declare function makeDateParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.date>,
): ParamDef<Type.date>;
/** @deprecated */
export declare function makeDateArrayParameter(
  name: string,
  description: string,
  args?: ParamArgs<ArrayType<Type.date>>,
): ParamDef<ArrayType<Type.date>>;
/** @deprecated */
export declare function makeHtmlParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.html>,
): ParamDef<Type.html>;
/** @deprecated */
export declare function makeHtmlArrayParameter(
  name: string,
  description: string,
  args?: ParamArgs<ArrayType<Type.html>>,
): ParamDef<ArrayType<Type.html>>;
/** @deprecated */
export declare function makeImageParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.image>,
): ParamDef<Type.image>;
/** @deprecated */
export declare function makeImageArrayParameter(
  name: string,
  description: string,
  args?: ParamArgs<ArrayType<Type.image>>,
): ParamDef<ArrayType<Type.image>>;
/** @deprecated */
export declare function makeFileParameter(
  name: string,
  description: string,
  args?: ParamArgs<Type.file>,
): ParamDef<Type.file>;
/** @deprecated */
export declare function makeFileArrayParameter(
  name: string,
  description: string,
 ...
 */
export declare function makeNumericFormula<ParamDefsT extends ParamDefs>(
 ...
 */
export declare function makeStringFormula<ParamDefsT extends ParamDefs>(
 ...
 */
export declare type ArrayFormulaDef<ParamDefsT extends ParamDefs, SchemaT extends Schema> = BaseFormulaDef<
  ParamDefsT,
 ...
 */
export declare type ObjectFormulaDef<ParamDefsT extends ParamDefs, SchemaT extends Schema> = BaseFormulaDef<
  ParamDefsT,
  SchemaType<SchemaT>
> & {
  resultType: ValueType.Object;
 ...
 */
export declare type FormulaDefinition<
  ParamDefsT extends ParamDefs,
  ResultT extends ValueType,
 ...
 */
export declare type MetadataFunction = (
 ...
 * ```
 */
export declare function simpleAutocomplete<T extends AutocompleteParameterTypes>(
 ...
 */
export declare function makeSimpleAutocompleteMetadataFormula<T extends AutocompleteParameterTypes>(
  options: Array<TypeMap[AutocompleteParameterTypeMapping[T]] | SimpleAutocompleteOption<T>>,
): MetadataFormula;
/** @deprecated */
export declare function makeObjectFormula<ParamDefsT extends ParamDefs, SchemaT extends Schema>({
  response,
  ...definition
...
/** @deprecated */
export declare function makeSyncTableLegacy<
  K extends string,
  L extends string,
  ParamDefsT extends ParamDefs,
  SchemaT extends ObjectSchema<K, L>,
 ...
 * ```
 */
export declare function makeDynamicSyncTable<
  K extends string,
  L extends string,
  ParamDefsT extends ParamDefs,
  SchemaT extends ObjectSchemaDefinition<K, L>,
...
export declare function maybeRewriteConnectionForFormula<
  ParamDefsT extends ParamDefs,
